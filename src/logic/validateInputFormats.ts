...
export enum AuthValidationResponses {
  ...
  invalidUsernameFormat = 'Username must be at least 5 characters long and not contain spaces',
...
export const handleValidationResponses = (res, whatMethodOfEnter) => {
  let responses = {}
  if (whatMethodOfEnter === 'register') {
